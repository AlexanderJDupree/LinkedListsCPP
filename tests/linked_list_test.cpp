...
TEST_CASE("Using the copy-assignment operator", "[operators], [copy-assignment]")
{
    ...
    {
        linked_list<int> old { 1, 2, 3 };
        linked_list<int> list = std::move(old);
...
TEST_CASE("Testing equality between lists", "[operators], [equality]")
{
    ...
    {
         linked_list<int> lhs { 1, 2, 3 };
         linked_list<int> rhs { 1, 2, 3, 4 };
...
{
    linked_list<int> empty_list;
    linked_list<int> list { 1, 4, 2, 3, 4, 5, 6 };
    ...
    {
        linked_list<int> singular_list { 1 };
...
{
    linked_list<int> list { 1, 4, 2, 3, 4 };
...
TEST_CASE("Using functors to remove a specific element", "[remove_if]")
{
    SECTION("remove_if with a value constructed functor")
    {
        ...
        linked_list<int> list(nums, nums + 9);
    ...
    SECTION("remove_if with the element as the head")
    {
        ...
        linked_list<int> list(nums, nums + 7);
    ...
    SECTION("remove_if with no matching element")
    {
        ...
        linked_list<int> list(nums, nums + 6);
...
TEST_CASE("Reversing the order of a list", "[reverse]")
{
    ...
    SECTION("A populated list")
    {
        linked_list<int> list { 5, 4, 3, 2, 1 };
...
TEST_CASE("Merging two sorted lists", "[merge]")
{
    ...
    {
        linked_list<int> first { 1, 3, 5 };
        linked_list<int> second { 2, 4, 6 };
    ...
    {
        linked_list<int> first { 2, 4, 6 };
        linked_list<int> second { 1, 3, 5 };
    ...
    {
        linked_list<int> first { 1, 2, 3 };
        linked_list<int> second { 4, 5, 6 };
    ...
    {
        linked_list<int> first { 6 };
        linked_list<int> second { 1, 2, 3, 4, 5 };
    ...
    {
        linked_list<int> first { 1, 2, 3, 4, 5 };
        linked_list<int> second;
    ...
    {
        linked_list<int> first { 3, 2, 1 };
        linked_list<int> second { 6, 5, 4 };
    ...
    {
        linked_list<int> first { 2 };
        linked_list<int> second { 1 };
...
TEST_CASE("Splitting lists into smaller lists with iterators", "[split]")
{
    ...
    {
        linked_list<int> head { 1, 2, 3, 4, 5, 6 };
        linked_list<int> tail = head.split(head.begin());
    ...
    {
        linked_list<int> left { 1, 2, 3, 4, 5, 6, 7 };
        linked_list<int> right = left.split(left.middle());
    ...
    {
        linked_list<int> left;
        linked_list<int> right  = left.split(left.begin());
    ...
    SECTION("Splitting at the end of the list returns the empty list")
    {
        ...
        linked_list<int>::const_iterator it = left.begin();

        while(*(it++) != 7);

        linked_list<int> right = left.split(it);
    ...
    SECTION("Splitting the list with an end iterator returns the empty list")
    {
        ...
        linked_list<int> right = left.split(left.end());
    ...
    SECTION("Splitting the list with an iterator does not modify the iterator")
    {
        ...
        linked_list<int>::iterator it = list.begin();
        linked_list<int> split = list.split(it);
...
TEST_CASE("Sorting lists", "[sort]")
{
    ...
    {
        linked_list<int> list { 3, 5, 2, 1, 4, 6 };
